...
ArrayList<Integer> keysPressed = new ArrayList<Integer>();
  ...
  TextBox(Drehsystem3d drehsystem3d, PApplet context, int posX, int posY) {
    super(context, posX, posY);
	TextBox = drehsystem3d;
    if (context == null) return;
    this.context = context;
    pos = new PVector(posX, posY, 0);
  }

  TextBox(Drehsystem3d drehsystem3d, PApplet context, int posX, int posY, int w, int h) {
  ...
  TextBox(Drehsystem3d drehsystem3d, PApplet context, PVector pos) {
    super(context, pos);
	TextBox = drehsystem3d;
    if (context == null) return;
    this.context = context;
  ...
  TextBox(Drehsystem3d drehsystem3d, PApplet context, PVector pos, int w, int h) {
  ...
  public void resetCursor() {
    ...
    this.cursorTimer = TextBox.millis();
  }
  ...
  public void showCursor() {
    ...
    if (this.clicked) {
      if (TextBox.millis() - cursorTimer >= 500) {
        cursorVisible = !cursorVisible;
        cursorTimer = TextBox.millis();
      }
